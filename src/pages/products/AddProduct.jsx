...
const AddProduct = () => {
  ...
  useEffect(() => {
    inventoryService.getAll({ activeOnly: true })
      .then(setMaterials)
      .catch(err => setError('Could not load raw materials: ' + err.message))
  }, [])
  ...
  // Live preview only — the saved cost always comes from the database trigger.
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (validItems.length > 0) {
        await productService.setRecipe(product.id, validItems.map(i => ({
    ...
    <div className="page-wrapper" style={{ maxWidth: 860 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 24 }}>
        ...
        <div>
          ...
          <p className="page-subtitle">Enter the selling price and recipe — the product cost is calculated automatically.</p>
        </div>
      </div>
        ...
        <div className="card" style={{ padding: 24, marginBottom: 20 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 14px' }}>
            <div className="form-group">
              ...
              <input className="input-base" value={form.name} onChange={set('name')} required placeholder="Chocolate Kunafa Cup" />
            </div>
            <div className="form-group">
              <label>SKU</label>
            ...
            <div className="form-group" style={{ gridColumn: 'span 2' }}>
              ...
              <textarea className="input-base" rows={3} value={form.description} onChange={set('description')} placeholder="Chocolate and kunafa dessert cup" />
            </div>
          </div>
        </div>
...
{/* Selling price */}
        ...
        <div className="card" style={{ padding: 24, marginBottom: 20 }}>
          ...
          <p style={{ fontSize: 12, color: 'var(--text-muted)', marginBottom: 14 }}>
            Select the raw materials and the quantity needed to make one unit. Cost per KG is converted to a per-gram cost automatically.
          </p>
          ...
          {/* Live cost preview (saved value comes from the database) */}
          <div className="grid-4" style={{ marginTop: 18, gap: 10 }}>
            {[
              { label: 'Recipe Cost',   value: formatCurrency(previewCost),  color: '#3b82f6' },
